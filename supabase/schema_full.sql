...
-- Called from Configuració > Eliminar compte. Every per-user table
-- references auth.users with ON DELETE CASCADE, so removing the auth
-- user removes all of the user's data in one statement.
