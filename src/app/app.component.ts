...
export class AppComponent {
  ...
  // Igual: escolta les navegacions des de la primera perquè cada pàgina
  // s'obri a dalt i l'enrere torni on eres.
  private scrollRestore = inject(ScrollRestoreService);
